...
public class TcBddComposites {
        ...
        @Composite(steps = ["Given variable className has value TestViewComposites", "When File is copied from test/mocks/@className.groovy.tmpl to composites/@className.groovy", "Given Web address /page/composites/composites.com.technologyconversations.bdd.steps.@className is opened"])
        def compositeStep19() { }
        ...
        @Composite(steps = ["Given variable className has value TestComposites", "Given File composites/@className.groovy does NOT exist", "Given Web address /page/composites/composites.com.technologyconversations.bdd.steps.@className is opened", "Given Web page is refreshed", "When Web user sets value Given this class has at least one Composite to the element compositeText", "When Web user sets value Given variable \$key has value \$value to the element compositeStep1"])
        def compositeStep24() { }
