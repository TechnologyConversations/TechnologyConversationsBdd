...
public class TcBddComposites {
        ...
        def compositeStep28(@Named("username") BddVariable username, @Named("password") BddVariable password) { }
        ...
        def compositeStep29(@Named("username") BddVariable username, @Named("password") BddVariable password) { }
        ...
        def compositeStep31(@Named("username") BddVariable username) { }
