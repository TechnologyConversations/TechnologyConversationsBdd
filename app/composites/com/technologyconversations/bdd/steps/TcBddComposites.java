...
public class TcBddComposites {
        ...
        @Composite(steps = {"Given Web home page is opened", "When Web user clicks the element browseComposites", "When Web user sets value TestComposites to the element className", "When Web user clicks the element createNewClass", "When Web user sets value Given this class has at least one Composite to the element compositeText"})
