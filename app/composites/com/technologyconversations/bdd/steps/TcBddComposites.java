...
public class TcBddComposites {
        ...
        @Composite(steps = {"Given File app/composites/com/technologyconversations/bdd/steps/TestComposites.java does NOT exist", "Given Web address /page/composites/composites.com.technologyconversations.bdd.steps.TestComposites is opened", "Given Web page is refreshed", "When Web user sets value Given this class has at least one Composite to the element compositeText", "When Web user sets value Given variable $key has value $value to the element compositeStep1"})
