...
public class TcBddComposites {
        ...
        public void compositeStep5(@Named("text") BddVariable text) { }
    
        @Given("Web user is in the View Story page")
        @Composite(steps = {"Given variable storyName has value testStory", "When File is copied from public/stories/tcbdd/storiesList.story to public/stories/testDirectory/testStory.story", "Given Web address /page/stories/view/testDirectory/testStory is opened", "When Web user clicks the element expandPanels"})
